...
// Error table
//
static char *PF_WarnMsg[] = { (char*) "page pinned in buffer",
    (char*) "page is not in the buffer", (char*) "invalid page number",
    (char*) "file open", (char*) "invalid file descriptor (file closed)",
    (char*) "page already free", (char*) "page already unpinned",
    (char*) "end of file", (char*) "attempting to resize the buffer too small",
    (char*) "invalid filename" };

static char *PF_ErrorMsg[] = { (char*) "no memory", (char*) "no buffer space",
    ...
    (char*) "hash table entry not found", (char*) "page already in hash table",
